# Base62id Encoding Specification for Binary UUID

## 1. Introduction

Base62id encoding is designed for encoding binary UUIDs into compact, order-preserving ASCII strings using 62 alphabet characters.
