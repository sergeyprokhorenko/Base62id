...
For keyboard entry, for filenames on case‑insensitive filesystems (Windows, macOS), for sorting in Excel, or wherever automatic case‑folding or character confusion may occur, the hex-and-dash string format is RECOMMENDED over Base62id.
